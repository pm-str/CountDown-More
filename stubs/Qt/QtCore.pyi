...
class pyqtSignal:
    def __init__(self, *types, name: str = ..., arguments: typing.List[str] = ...) -> None: ...
...
def pyqtSlot(*types, name: typing.Optional[str] = ..., result: typing.Optional[typing.Any] = ...) -> typing.Callable[..., typing.Optional[str]]: ...
...
def pyqtProperty(type: typing.Any,
